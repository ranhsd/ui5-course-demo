		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Demo",
									"targetURL": "#ui5demoui5demo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5demoui5demo-display": {
								"semanticObject": "ui5demoui5demo",
								"action": "display",
								"description": "UI5 Demo App",
								"title": "UI5 Demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.demo.ui5demo",
									"url": sap.ui.require.toUrl("ui5/demo/ui5demo")
								}
							}
						}
					}
